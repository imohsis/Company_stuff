...
class VideosCommentsController extends Controller
{
    ...
    public function create(Request $request){
        ...
        if(Utility::hasAccess($params->data["user"])){
            ...
            $data =  $model->comment('video_uid',$params->data['post_uid'],$params->data['comment']);

            $this->responseCode = Utility::RESPONSE_CODE_CREATED;
            $this->responseMessage = "Success";
            //if($data){
            $get_comment = $model->getComment("video_uid",$params->data['post_uid']);
    ...
    public function getComments(Request $request){
        ...
        Utility::sanitize($params->data);
            ...
            $get_comment = $model->fetchComment('video_uid', $params->data['post_uid'],

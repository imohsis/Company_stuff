...
class MusicCommentsController extends Controller
{
    ...
    public function create(Request $request){
        ...
        if(Utility::hasAccess($params->data["user"])){
            ...
            $data =  $model->comment('music_uid',$params->data['post_uid'],$params->data['comment']);

            $this->responseCode = Utility::RESPONSE_CODE_CREATED;
            $this->responseMessage = "Success";
            //if($data){
            $get_comment = $model->getComment("music_uid",$params->data['post_uid']);
    ...
    public function getComments(Request $request){
        ...
        Utility::sanitize($params->data);
            ...
            $this->responseCode = Utility::RESPONSE_CODE_CREATED;
            $this->responseMessage = "Success";
            $get_comment = $model->fetchComment('music_uid', $params->data['post_uid'],
